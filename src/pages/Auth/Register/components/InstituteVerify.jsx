        ...
        <AlertDialog open={showSkipDialog} onOpenChange={openSkipDialog}>
          <AlertDialogContent className="font-spaceGrotesk bg-neutral-50">
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction className="text-base rounded dark:bg-red-600/30 dark:border-red-800/40 border-red-800/40 border-2 dark:text-gray-50 text-red-600 dark:hover:bg-red-600/60 transition-colors duration-300 w-28 bg-transparent hover:bg-red-300/60">
                Continue
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
